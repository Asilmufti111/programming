...
public class BSTdemo {
        ...
        do {
            ...
            if (choice == 1) {
                ...
                if (myTree.isEmpty()) {
                    ...
                    if (myTree.IsFullBST(myTree.getRoot()) == true) {
                        System.out.println(">The given BST is a Full BST\n>");
                    } else {
                        System.out.println(">The given BST is not a Full BST\n>");
                    }
                }
            } else if (choice == 7) {
    ...
    public static void showMenu() {
        ...
        System.out.println("|   3. Print nodes gratear than some value              |");
        System.out.println("|   4. Print sum of children of some node               |");
        System.out.println("|   5. Print number of inner nodes of tree              |");
        System.out.println("|   6. Determine whether given BST in Full BST or not   |");
